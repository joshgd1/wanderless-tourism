...
| `guide-profile.md`       | Guide       | Expertise vector, availability, MICT licensing, matching and booking management |
...
| Spec                       | Domain   | Description                                                             |
| -------------------------- | -------- | ----------------------------------------------------------------------- |
| `auth-identity.md`         | Platform | Tourist/guide/partner authentication, identity verification (prototype) |
| `payment-escrow.md`        | Platform | Escrow state machine, booking flow, commission collection (prototype)   |
...
| Spec                       | Domain   | Description                                                         |
| -------------------------- | -------- | ------------------------------------------------------------------- |
| `commission-settlement.md` | Finance  | 15-18% commission, guide payout, partner referral split (prototype) |
...
| Spec               | Domain    | Description                                                     |
| ------------------ | --------- | --------------------------------------------------------------- |
| `city-playbook.md` | Expansion | Luang Prabang → Singapore/Hoi An → 5-8 city expansion framework |
...
| Luang Prabang beachhead      | `city-playbook.md`                         |
...
| `guide-profile.md`          | Complete | MICT licensing, expertise vector, tier system (Free/Pro/Expert), lifecycle states                             |
