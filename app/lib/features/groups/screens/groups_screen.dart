...
final _syntheticGroups = [
  TravelGroup(
    ...
    proposedDuration: 3.0,
    minSize: 3,
    maxSize: 8,
    memberCount: 4,
    members: [
      TravelGroupMember(initials: 'SA', colorHex: '#4A90D9', status: 'JOINED'),
      TravelGroupMember(initials: 'MI', colorHex: '#50C878', status: 'JOINED'),
      TravelGroupMember(initials: 'EM', colorHex: '#FFB6C1', status: 'JOINED'),
      TravelGroupMember(initials: 'JA', colorHex: '#DAA520', status: 'PENDING'),
    ],
  ),
  TravelGroup(
    id: 2,
    ...
    members: [
      ...
      TravelGroupMember(initials: 'CL', colorHex: '#FFB6C1', status: 'PENDING'),
      TravelGroupMember(initials: 'DA', colorHex: '#DAA520', status: 'PENDING'),
      TravelGroupMember(initials: 'EV', colorHex: '#9B59B6', status: 'PENDING'),
      TravelGroupMember(initials: 'FR', colorHex: '#E67E22', status: 'PENDING'),
    ],
  ),
  TravelGroup(
    id: 3,
    ...
    proposedDuration: 5.0,
    minSize: 3,
    maxSize: 8,
    memberCount: 3,
    members: [
      TravelGroupMember(initials: 'GR', colorHex: '#FFB6C1', status: 'JOINED'),
      TravelGroupMember(initials: 'HE', colorHex: '#50C878', status: 'JOINED'),
      TravelGroupMember(initials: 'IR', colorHex: '#4A90D9', status: 'PENDING'),
    ],
  ),
  TravelGroup(
    id: 4,
    ...
    memberCount: 5,
    members: [
      TravelGroupMember(initials: 'JA', colorHex: '#50C878', status: 'JOINED'),
      TravelGroupMember(initials: 'KA', colorHex: '#FFB6C1', status: 'JOINED'),
      TravelGroupMember(initials: 'LE', colorHex: '#DAA520', status: 'PENDING'),
      TravelGroupMember(initials: 'MI', colorHex: '#4A90D9', status: 'PENDING'),
      TravelGroupMember(initials: 'NO', colorHex: '#9B59B6', status: 'PENDING'),
    ],
  ),
];
