              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _buildBackButton(),
                    const SizedBox(height: AppSpacing.xl),
                    Text('Business Registration', style: AppText.h1),
                    const SizedBox(height: 6),
                    Text(
                      'Create your business account to manage tours.',
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                _buildBrandMark(),
                const SizedBox(height: AppSpacing.lg),
                Text('Business Registration', style: AppText.display),
                const SizedBox(height: 6),
                Text(
                  'Create your business account to manage tours.',
      ...
      child: Column(
        children: [
          ...
          AppTextField(
            ...
            prefix: const Icon(Icons.store_outlined, size: 18, color: AppColors.textTertiary),
            validator: (v) {
