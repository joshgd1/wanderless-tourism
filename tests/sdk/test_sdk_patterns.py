...
def tc_(name):
    """Test decorator — prefixed with _ to avoid pytest collecting it as a test"""
...
def test_core_sdk_patterns():
    ...
    @tc_("Create workflow with 3-param add_node")
    def _():
        from kailash.workflow.builder import WorkflowBuilder
    ...
    @tc_("Create connection with 4-param add_connection")
    def _():
        from kailash.workflow.builder import WorkflowBuilder
    ...
    @tc_("Execute workflow with LocalRuntime")
    def _():
        from kailash.workflow.builder import WorkflowBuilder
        from kailash.runtime import LocalRuntime
    ...
    @tc_("LocalRuntime returns (results, run_id) tuple")
    def _():
        from kailash.workflow.builder import WorkflowBuilder
        from kailash.runtime import LocalRuntime
...
def test_runtime_configuration():
    ...
    @tc_("LocalRuntime with debug=True")
    def _():
        from kailash.runtime import LocalRuntime
    ...
    @tc_("LocalRuntime with enable_cycles=True")
    def _():
        from kailash.runtime import LocalRuntime
    ...
    @tc_("LocalRuntime with connection_validation='strict'")
    def _():
        from kailash.runtime import LocalRuntime
    ...
    @tc_("LocalRuntime with conditional_execution='skip_branches'")
    def _():
        from kailash.runtime import LocalRuntime
    ...
    @tc_("LocalRuntime has validate_workflow method")
    def _():
        from kailash.runtime import LocalRuntime
    ...
    @tc_("LocalRuntime has get_validation_metrics method")
    def _():
        from kailash.runtime import LocalRuntime
...
def test_node_patterns():
    ...
    @tc_("PythonCodeNode can execute")
    def _():
        from kailash.workflow.builder import WorkflowBuilder
        from kailash.runtime import LocalRuntime
...
def test_async_patterns():
    ...
    @tc_("AsyncLocalRuntime can be instantiated")
    def _():
        from kailash.runtime import AsyncLocalRuntime
    ...
    @tc_("AsyncLocalRuntime has execute_workflow_async method")
    def _():
        from kailash.runtime import AsyncLocalRuntime
    ...
    @tc_("AsyncLocalRuntime with max_concurrent_nodes")
    def _():
        from kailash.runtime import AsyncLocalRuntime
...
def test_workflow_builder_features():
    ...
    @tc_("WorkflowBuilder.build() returns workflow object")
    def _():
        from kailash.workflow.builder import WorkflowBuilder
    ...
    @tc_("Workflow has nodes attribute")
    def _():
        from kailash.workflow.builder import WorkflowBuilder
    ...
    @tc_("Multiple nodes can be added")
    def _():
        from kailash.workflow.builder import WorkflowBuilder
    ...
    @tc_("Connections create data flow")
    def _():
        from kailash.workflow.builder import WorkflowBuilder
        from kailash.runtime import LocalRuntime
...
def test_mcp_patterns():
    ...
    @tc_("MCP server has required methods")
    def _():
        from kailash.mcp_server import MCPServer
...
def test_context_patterns():
    ...
    @tc_("Runtime can be used as context manager")
    def _():
        from kailash.workflow.builder import WorkflowBuilder
        from kailash.runtime import LocalRuntime
