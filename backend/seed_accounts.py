    ...
    trip_plans = [
        {
            ...
            "tour_date_start": (datetime.utcnow() + timedelta(days=14)).strftime("%Y-%m-%d"),
            "tour_date_end": (datetime.utcnow() + timedelta(days=16)).strftime("%Y-%m-%d"),
            "duration_hours": 6.0,
            "group_size": 2,
            "safety_weight": 1.0,
        ...
        },
        {
            ...
            "tour_date_start": (datetime.utcnow() + timedelta(days=21)).strftime("%Y-%m-%d"),
            "tour_date_end": (datetime.utcnow() + timedelta(days=24)).strftime("%Y-%m-%d"),
            "duration_hours": 8.0,
            "group_size": 4,
            "safety_weight": 0.5,
