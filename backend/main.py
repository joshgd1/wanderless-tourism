    ...
    return [
        {
            ...
            "tourist_name": tourist_map.get(tp.tourist_id).name if tp.tourist_id in tourist_map else None,
            "tourist_photo_url": tourist_map.get(tp.tourist_id).photo_url if tp.tourist_id in tourist_map else None,
